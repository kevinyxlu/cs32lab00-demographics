...
void read_csv(std::string filename, std::vector<std::string>& theCounties, std::vector<double>& thePopOver65,  std::vector<double>& thePopUnder18);

// Read one line from a CSV file for county demographic data specifically
void readCSVLineDemog(std::string theLine, std::vector<std::string>& theCounties, std::vector<double>& thePopOver65, std::vector<double>& thePopUnder18);
